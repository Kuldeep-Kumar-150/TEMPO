...
const WatchVideo = () => {
    return (
        <section className='py-sm-5 my-sm-5 z_3 position-relative'>
            <img
                className="position-absolute top-0 start-0 w_6 zn_1"
                src={leftPosition}
                alt="leftPosition"
            />
            <img
                className="position-absolute bottom-0 end-0 w_6 zn_1"
                src={rightPosition}
                alt="rightPosition"
            />
